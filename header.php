...
?>
    <!-- Title  -->
    <title>Inab - <?php print $site_title ?></title>
...
?>
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img class="navbar-brand-regular" src="assets\img\inab_logo.png" alt="brand-logo">
                        <img class="navbar-brand-sticky" src="assets\img\inab_logo.png" alt="sticky brand-logo">
                    </a>
